        ...
        pieces: [
            {
                ...
                info: ['Bernhard Crusell föddes i Nystad i Finland 1775, son till en fattig bokbindare. Han utbildade sig till klarinettist och trots en klen hälsa gick han in vid militärmusiken på Sveaborg.'+
                    ...
                    '\n\nCrusell besökte aldrig Finland efter Tsarrysslands annektering 1809. I den finska självbilden uppfattas han ändå som finsk eftersom han var den första betydande tonsättaren som fötts i landet. Dirigenten Robert Kajanus betecknade honom som ”den finska musikens fader”. Kanske i en iver att lansera ett ”inhemskt” alternativ till den tyskfödde Fredrik Pacius, som ju var den som lade grunden för musiklivet i Helsingfors? frågar sig Crusells biograf Fabian Dahlström.'+
            ...
            },
            {
                ...
                info: 'Liksom fallet är med en rad andra tonsättares symfonier, har under årens lopp vissa problem uppstått med numreringen hos Antonin Dvorák och det är först under senare är, närmare bestämt efter andra världskriget, som man har kommit fram till en viss enhetlighet. Anledningen till den förbistring som rädde tidigare var att Dvorák hade en schism med sin berlinske förläggare Simrock. Denne, som hade gjort en smärre förmögenhet på Dvoráks slaviska danser, som man kunde höra misshandlas på fyrhändigt piano i minsta kyffe, klagade över att den tjeckoslova­kiske mästarens större verk inte alls gav samma inkomster, och när Antonin Dvorák lämnade in sin G­-dursymfoni visade sig Simrock föga intresserad. En irriterad brevväxling kom till stånd, och slutet på det hela blev att Dvorák lät trycka symfonin hos den engelska firman Novello.'+
                    ...
                    '\n\nHela denna manipulation, plus bl a det faktum att Simrock väntade med att trycka ett par av Dvorák symfonier till efter hans död, gjorde dock att den dåtida numreringen inte alls stämde. G-dursymfonin var alltså länge känd som nr 4, och "Från nya världen" som nr 5 (numera bär den nr 9).'+
                    '\n\n1889 hade Antonin Dvorák i ett brev till en vän klagat över att hans huvud var så "fullt av ideer" att han bara kunde beklaga att det tog så lång tid att skriva ned dem. Att han, i motsats till detta uttalande, var kapabel att arbeta synnerligen snabbt bevisas av att symfonin, som påbörjades i augusti samma år, var klar efter bara tre månader. Den är tillägnad "Kejsar Franz Josefs böhmiska akademi för konstens och litteraturens fromma, med tack för mitt inval".'+
                ...
                composer: {
                        ...
                        more: 'Om folkmusik:'+
                            '\nDvorák var starkt intresserad av mährisk och böhmisk folkmusik och inspirerades ofta av folkmusikaliska idiom i sina egna kompositioner. När han bodde i USA i slutet av 1800-talet ville han utforska traditionell amerikansk musik och uppmuntrade afroamerikanska och indianska influenser i strävan efter en nationell musikalisk identitet.'
                }
            },
            {
                name: 'BERWALDBONUS: TONSÄTTARINNOR',
                image: images_url+'',
                info: 'Efter fyra av säsongens onsdagskonserter blir det kammarmusikaliska bonuskonserter med musik av svenska kvinnliga tonsättare från 1800-talets andra och 1900-talets första hälft. Konserterna är ett samarbete mellan Berwaldhallen och Sveriges Radio P2 och introduceras av musikforskaren och producenten Christina Tobeck.'+
                    '\n\nBerwaldbonusen sker i direkt anslutning till konsertenoch du som har besökt kvällens huvudkonsert kan kostnadsfritt stanna kvar på bonuskonserten. Abonnenter får som förmån alla Berwaldbonuskonserterna kostnadsfritt. Ta med ditt abonnemangskort! Du får gärna försöka hitta en plats närmare scenen eftersom kammarmusiken är i det mindre formatet.'+
                    '\n\nPer Sporrong: violin'+
                    '\nJohan Ullén: piano'+
